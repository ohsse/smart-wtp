...
**Domain:** Smart water treatment plant backend / industrial operations platform
**Researched:** 2026-03-31
**Confidence:** HIGH

## Baseline Assessment

The chosen baseline is strong for this domain. `Java 21 + Spring Boot 4 + PostgreSQL` is a conservative, auditable, operations-friendly stack, which matters more for plant control and telemetry than fashionable architecture choices. `JPA + MyBatis` is also a valid mix here, because this backend has two very different workloads: transactional state changes and heavy operational reads.

The main risk is not missing a library. The main risk is stack drift:
...
This stack should stay intentionally boring. Add support only where it improves auditability, operability, restartability, or boundary enforcement.
...
dependencies {
    ...
    // add only if scheduler is horizontally scaled
...
**If Kafka is the plant integration backbone:**
...
**If Java must talk directly to PLC or gateway protocols:**
...
**If telemetry volume grows beyond comfortable PostgreSQL history performance:**
...
---
*Stack research for: smart water treatment plant backend*
*Researched: 2026-03-31*
