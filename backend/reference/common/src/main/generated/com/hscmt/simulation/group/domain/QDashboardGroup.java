...
/**
 * QDashboardGroup is a Querydsl query type for DashboardGroup
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QDashboardGroup extends EntityPathBase<DashboardGroup> {

    private static final long serialVersionUID = 767570171L;

    public static final QDashboardGroup dashboardGroup = new QDashboardGroup("dashboardGroup");
    ...
    public QDashboardGroup(String variable) {
        super(DashboardGroup.class, forVariable(variable));
    }

    public QDashboardGroup(Path<? extends DashboardGroup> path) {
        super(path.getType(), path.getMetadata());
    }

    public QDashboardGroup(PathMetadata metadata) {
        super(DashboardGroup.class, metadata);
    }
