...
def main():
    ...
    while True:
        try:
            ...
            test_acq_date_time = '2025-04-23 13:41:59.000'
            ...
            for acq_datetime in acq_date_rows:
                ...
                for key in keys:
                    ...
                    sql = f"""INSERT IGNORE INTO TB_AI_DIAG_MOTOR(motor_id, center_id, acq_date, unbalance_amp,unbalance_alarm,misalignment_amp,misalignment_alarm,rotor_amp
                ...
                for key in keys:
                    sql = f"""INSERT IGNORE INTO TB_AI_DIAG_PUMP(pump_id, center_id, acq_date, impeller_amp,impeller_alarm,cavitation_amp,cavitation_alarm,de_amp,DE_rms_amp
